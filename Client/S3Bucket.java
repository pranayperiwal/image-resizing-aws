...
public class S3Bucket {
	...
	public boolean downloadFile(String key, String filePath, String fileName) {
		try {
			S3Object o = s3.getObject(bucketName, key);
			S3ObjectInputStream s3is = o.getObjectContent();
			FileOutputStream fos = new FileOutputStream(new File("processed_" + fileName));
